...
public class BasketPage {
    ...
    public BasketPage addGameToCart() {
    ...
    public BasketPage successBasketGame() {
    ...
    public BasketPage deleteBasketGames() {
    ...
    public BasketPage successBasketEmpty() {
