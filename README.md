...
- <a name="Allure_report1"><h4>Страница сборки job в [Jenkins](https://jenkins.autotests.cloud/job/DiplomaSteam/178/)</h4></a>

![This is an image](design/pictures/jenkins1.png)

- <a name="Allure_report1"><h4>Главный экран со списком job в [Jenkins](https://jenkins.autotests.cloud/job/DiplomaSteam/)</h4></a>
